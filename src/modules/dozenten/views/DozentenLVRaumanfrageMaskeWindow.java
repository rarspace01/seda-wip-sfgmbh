...
public class DozentenLVRaumanfrageMaskeWindow extends JFrame {
	...
	public DozentenLVRaumanfrageMaskeWindow() {
		...
		JLabel lblNewLabel = new JLabel("Geben Sie einen bevorzugten Raum an:");
		...
		JLabel lblNewLabel_1 = new JLabel("Oder legen Sie die speziellen Anforderungen fest f\u00FCr die Raumanfrage:");
		contentPane.add(lblNewLabel_1, "cell 1 5 8 1");
