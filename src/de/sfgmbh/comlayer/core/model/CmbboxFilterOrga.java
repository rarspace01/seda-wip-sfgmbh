 ...
 *
 */
public class CmbboxFilterOrga extends DefaultComboBoxModel<String> implements IntfAppObservable,KeyListener, ActionListener{
	 ...
	 * @param variant
	 */
	public CmbboxFilterOrga(String variant) {
