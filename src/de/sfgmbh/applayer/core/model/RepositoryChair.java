...
public class RepositoryChair implements IntfAppObservable, IntfDataObserver,
	 ...
	 * 
	 * @see
	 * de.sfgmbh.applayer.core.model.IntfRepositoryChair#getByFilter(java.util
	 * .HashMap)
	 */
	@Override
	public List<IntfChair> getByFilter(HashMap<String, String> filter) {
		return DataModel.getInstance().getDataHandlerChair()
				.getByFilter(filter);
	}
	 ...
	 * 
	 * @see
	 * de.sfgmbh.applayer.core.model.IntfRepositoryChair#getForAcronym(java.
	 * lang.String)
	 */
	@Override
	public IntfChair getForAcronym(String acronym) {
		return DataModel.getInstance().getDataHandlerChair()
				.getForAcronym(acronym);
	}
	 ...
	 * 
	 * @see
	 * de.sfgmbh.applayer.core.model.IntfRepositoryChair#delete(de.sfgmbh.applayer
	 ...
	 * 
	 * @see
	 * de.sfgmbh.applayer.core.model.IntfRepositoryChair#save(de.sfgmbh.applayer
	 * .core.definitions.IntfChair)
	 */
	@Override
