...
public class RepositoryUser implements IntfAppObservable, IntfDataObserver,
	 ...
	 * 
	 * @see
	 * de.sfgmbh.applayer.core.model.IntfRepositoryUser#getByFilter(java.util
	 * .HashMap)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * de.sfgmbh.applayer.core.model.IntfRepositoryUser#save(de.sfgmbh.applayer
	...
	public void register(IntfAppObserver observer) {
		if (observer instanceof IntfAppObserver) {
			...
			AppModel.getInstance()
					.getExceptionHandler()
					.setNewException(
							"Das Objekt implementiert nicht das Observer-Interface und kann daher nicht hinzugefügt werden!<br />Fehler: RepositoryUser-01",
							"Fehler!");
		}
	}
	 ...
	 * 
	 * @see
	 * de.sfgmbh.applayer.core.model.IntfRepositoryUser#delete(de.sfgmbh.applayer
	 * .core.definitions.IntfUser)
	 */
	@Override
