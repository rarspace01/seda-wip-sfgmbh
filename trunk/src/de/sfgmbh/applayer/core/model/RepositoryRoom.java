...
public class RepositoryRoom implements IntfAppObservable, IntfDataObserver,
	 ...
	 * 
	 * @see
	 * de.sfgmbh.applayer.core.model.IntfRepositoryRoom#getByFilter(java.util
	 * .HashMap)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * de.sfgmbh.applayer.core.model.IntfRepositoryRoom#save(de.sfgmbh.applayer
	 ...
	 * 
	 * @see
	 * de.sfgmbh.applayer.core.model.IntfRepositoryRoom#delete(de.sfgmbh.applayer
	 * .core.definitions.IntfRoom)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * de.sfgmbh.applayer.core.model.IntfRepositoryRoom#register(de.sfgmbh.applayer
	 * .core.definitions.IntfAppObserver)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * de.sfgmbh.applayer.core.model.IntfRepositoryRoom#unregister(de.sfgmbh
	 * .applayer.core.definitions.IntfAppObserver)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * de.sfgmbh.applayer.core.model.IntfRepositoryRoom#getByNumber(java.lang
	 * .String)
	 */
	@Override
	public IntfRoom getByNumber(String roomNumber_) {
		...
		room = DataModel.getInstance().getDataHandlerRoom().getByFilter(filter)
				.get(0);
		return room;
	}
