...
public class RoomRequestDialog extends JDialog {
	...
	public void setRoomAllocation(IntfRoomAllocation roomAllocation) {
		...
		getCmbboxSemester().setSelectedItem(this.proposalAllocation_.getSemester_());
		...
		getLblCountSeats().setText(String.valueOf(this.proposalAllocation_.getRoom_().getSeats_()));
		getLblCountBeamer().setText(String.valueOf(this.proposalAllocation_.getRoom_().getBeamer_()));
		getLblCountBoards().setText(String.valueOf(this.proposalAllocation_.getRoom_().getChalkboards_()));
		getLblCountOverheads().setText(String.valueOf(this.proposalAllocation_.getRoom_().getOverheads_()));
		getLblCountPcs().setText(String.valueOf(this.proposalAllocation_.getRoom_().getPcseats_()));
		getLblCountVisual().setText(String.valueOf(this.proposalAllocation_.getRoom_().getVisualizer_()));
		getLblCountWhiteboards().setText(String.valueOf(this.proposalAllocation_.getRoom_().getWhiteboards_()));
	...
	public JTextArea getTxtrUnterbreitenSieDem() {
		if (txtMessageForCoutnerProposal_ == null) {
			...
			txtMessageForCoutnerProposal_.setFont(new Font("Tahoma", Font.PLAIN, 11));
			...
			txtMessageForCoutnerProposal_.setText("Suchen Sie einen passenden Raum und Termin für die Veranstaltung " +
	...
	public JTextField getTxtSeats() {
		if (txtSeats_ == null) {
			...
			txtSeats_.setToolTipText("Geben Sie die Anzahl der Sitzplätze für die Studenten an");
	...
	public JTextField getTxtBeamer() {
		if (txtBeamer_ == null) {
			...
			txtBeamer_.setToolTipText("Geben Sie die benötigte Anzahl von Beamern an");
	...
	public JTextField getTxtVisual() {
		if (txtVisual_ == null) {
			...
			txtVisual_.setToolTipText("Geben Sie die benötigte Anzahl von Visualizer an");
	...
	public JTextField getTxtOverhead() {
		if (txtOverhead_ == null) {
			...
			txtOverhead_.setToolTipText("Geben Sie die benötigte Anzahl von Overheads an");
	...
	public JTextField getTxtBoard() {
		if (txtBoard_ == null) {
			...
			txtBoard_.setToolTipText("Geben Sie die benötigte Anzahl von Tafeln an");
			txtBoard_.setText("0");
	...
	public JTextField getTxtWhiteboard() {
		if (txtWhiteboard_ == null) {
			...
			txtWhiteboard_.setToolTipText("Geben Sie die benötigte Anzahl von Whiteboards an");
	...
	public JTextArea getTxtrLegenSieWunschgren() {
		if (txtProposeWish_ == null) {
			...
			txtProposeWish_.setText("Legen sie Wunschgrößen fest und lassen Sie sich einen freien Raum vorschlagen (hinter Ihren Wunschgrößen sehen Sie die Größen des aktuellen Raumes):");
