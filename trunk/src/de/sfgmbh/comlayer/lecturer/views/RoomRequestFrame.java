...
public class RoomRequestFrame extends JFrame {
	...
	private void initialize() {
		...
		contentPane.add(lblNewLabel_3, "cell 2 1 2 1");
		
		JLabel lblNewLabel = new JLabel("Geben Sie ihren Raum- und Zeitwunsch an:");
		contentPane.add(lblNewLabel, "cell 1 3 3 1");
		...
		contentPane.add(lblNewLabel_1, "cell 1 8 4 1");
		...
		contentPane.add(btnAbbrechen, "cell 3 20,alignx right");
