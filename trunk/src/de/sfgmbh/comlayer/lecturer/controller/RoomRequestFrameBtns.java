...
public class RoomRequestFrameBtns implements ActionListener {
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (this.ctrlAction.equals("go")){
			this.getInfoWindow("<strong>Ihre Raumanfrage mit Ihrem gewünschten Raum konnte nicht gesendet werden:</strong><br> 1. Sie haben keinen Raum ausgewählt. " +
					"<br> 2. Sie haben keinen Tag ausgewählt. <br> 3. Sie haben keine Zeit ausgewählt. <br> <br><strong> <br>" +
					" Ihre Raumanfrage mit Ihren gewünschten Kriterien konnte nicht gesendet werden:</strong> <br> 1. Sie haben keinen Tag ausgewählt. <br> 2. Sie haben keine Zeit ausgewählt.<br>" +
