...
public class UserTab extends JPanel {
	...
	private void initialize() {
		...
		comboBoxUserclass_
				.setToolTipText("<html>Sie können die Liste der <br> Benutzer über <br> diese Filter begrenzen</html>");
		...
		userOrgaTable_.setModel(ViewManager.getInstance()
				.getOrgaUserTableModel());
		userOrgaTable_.setShowVerticalLines(false);
		userOrgaTable_.setBackground(SystemColor.activeCaption);
		userOrgaTable_.getColumnModel().removeColumn(
				userOrgaTable_.getColumn("Hidden"));
		...
		btnDelete_
				.setToolTipText("<html>Selektieren Sie einen Nutzer<br> und klicken Sie hier um diesen zu löschen</html>");
