...
public class LehrstuhlplanButton implements ActionListener {
	
	@Override
	public void actionPerformed(ActionEvent e) {
		Bootstrap.serviceManager.getCoreGUI().mainTabbedContainerPane.addTab("Lehrstuhlplan", null, new DozentenLehrstuhlplanTab(), null);
