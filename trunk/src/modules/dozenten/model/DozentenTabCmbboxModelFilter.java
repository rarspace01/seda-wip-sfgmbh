...
public class DozentenTabCmbboxModelFilter extends DefaultComboBoxModel<String> {

	private static final long serialVersionUID = 1L;
	
	public DozentenTabCmbboxModelFilter() {
		super(new String[] {"<alle>"});
	}
	public DozentenTabCmbboxModelFilter(String variant) {
